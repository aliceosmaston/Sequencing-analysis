...
```
The variablility at the ends of the sequencing runs affect the slope of the lines and should be cut off so that we compare the linear section of each run.
...
Now cut off the final sequencing hours which is uninformative and highly variable and disperse and only accounts for a small amount of the data output. We keep only the linear region of each plot.
